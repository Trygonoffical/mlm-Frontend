...
//   const [footerBg , setFooterBg] = useState('/Sliders/footerbg.png')
...
//   useEffect(() => {
//     if (companyInfo && companyInfo.footer_bg_image_url) {
//       setFooterBg(companyInfo.footer_bg_image_url);
//     } 
//   }, [companyInfo]);
...
const Footer = () => {
    ...
    // Create a footer background style object
    // const footerStyle = {
    //     backgroundImage: `url(${footerBg})`,
    //     backgroundRepeat: 'no-repeat',
    //     backgroundSize: 'cover'
...
if (footerBg) {
    ...
    footerStyle.backgroundPosition= 'center center';
                ...
                <div className="bg-gradient-to-r from-slate-700 to-green-900 text-white pt-12 pb-4 opacity-90">
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                            ...
                            <div className='w-full md:w-auto'>
                                <iframe 
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3503.5007461610985!2d77.31112207555113!3d28.584750975690895!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce45f16150aab%3A0x6fe40b4511945251!2sBasement%2C%20B%2C%2088%2C%20B%20Block%2C%20Sector%202%2C%20Noida%2C%20Uttar%20Pradesh%20201301!5e0!3m2!1sen!2sin!4v1734870506818!5m2!1sen!2sin" 
                                    width="auto" 
                                    height="auto" 
                                    className='w-full' 
                                    allowFullScreen="" 
