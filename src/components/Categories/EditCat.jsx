...
const EditCat = ({id={}, cats=[] , setRefreshKey}) => {
  ...
  return (
    <>
         <button className="bg-green-600 text-white px-2 py-2 mr-2 rounded hover:bg-green-700"  onClick={()=>showSidebarStatus()}>
                ...
                >
                    ...
                    <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                        ...
                        <div className="flex items-start justify-between">
                            <DialogTitle className="text-lg font-medium text-gray-900">Edit Categoies</DialogTitle>
                        ...
                        <div className="mt-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select
                                        value={formData.parent? formData.parent : 'None'}
