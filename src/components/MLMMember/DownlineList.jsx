...
//       });
//       const data = await response.json();
//       console.log('positions values - ' , data)
//       setPositions(data);
//     } catch (error) {
...
//     // Get current member's level (assuming it's available in memberData)
...
//             You can only add members up to level 2
//           </div>
//         )}
//       </div>
...
//                     As a level {memberData.level} member, you can only register members up to level 2.
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//               <button
//                 type="submit"
//                 disabled={loading || usernameCheck.isChecking}
//                 className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:opacity-50 flex items-center gap-2"
//               >
//                 {loading ? (
//                   <>
